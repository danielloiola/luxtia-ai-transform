        ...
        <div className="w-full max-w-5xl mx-auto px-6">
          <div className="text-center relative px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <h2 className="text-xl md:text-3xl lg:text-4xl font-semibold text-white/90 mb-8">
                Curadoria em Tecnologia & Inteligência Artificial
              </h2>
              
              <p className="text-lg md:text-2xl lg:text-3xl font-medium text-white/80 mb-8">
              ...
              <div className="mb-10">
                <p className="text-base md:text-lg lg:text-xl text-white/75 mb-8">
